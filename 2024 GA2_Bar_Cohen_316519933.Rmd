...
t_test_res <- apply(cent_final, 1, function(x) t.test(x[sampled_malig], x[non_malignant])$p.value)

#apply FDR correction to the p-values
p_values <- p.adjust(t_test_res, method = "fdr")
...
df <- data.frame(p_values = t_test_res, p_adjusted = p_values)
