...
plot(colSums(data_sc), xlab = "Genes", ylab = "Sum of expression", main = "Sum of expression per gene")



ggplot(metadata_sc, aes(x = complexity, y = cell_cycle_phase)) +
  geom_point() +
  labs(title = "Scatter plot of Complexity vs Cell Cycle Phase",
       x = "Complexity",
       y = "Cell Cycle Phase")
